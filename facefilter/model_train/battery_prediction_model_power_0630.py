...
class Model:
  ...
  def data_preprocessing(self, data_set):
    ...
    print("@@@@@@@@@@@@@@@@@@@@@@@@@@@ tatal_x_data=", total_x_data)
...
#@@train_target_dirs =["train_dataset/30s", "train_dataset/60s", "train_dataset/120s", "train_dataset/180s", "train_dataset/300s", "train_dataset/600s", "train_dataset/backup_120s"]
train_target_dirs =["train_dataset/iu", "train_dataset/kookyohwan"]
test_target_dirs =["test_dataset/30s", "test_dataset/60s", "test_dataset/120s", "test_dataset/180s", "test_dataset/300s", "test_dataset/600s"]
